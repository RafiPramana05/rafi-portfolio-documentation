...
<div class="container mx-auto px-6 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold gradient-text mb-2">Create New Project</h1>
        <p class="text-gray-400">Tambah project, experience, atau organization baru</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.projects.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="hidden" name="icon" id="icon" value="{{ old('icon', 'fas fa-graduation-cap') }}">
                    ...
                    <div class="mb-3 p-3 bg-gray-800 bg-opacity-50 border border-gray-600 rounded-lg">
                        <div class="flex items-center space-x-3">
                            <div class="w-8 h-8 flex items-center justify-center bg-blue-500 rounded-lg">
                                <i id="selected-icon" class="{{ old('icon', 'fas fa-graduation-cap') }} text-white"></i>
                            </div>
                            <span id="selected-icon-text" class="text-white">{{ old('icon', 'fas fa-graduation-cap') }}</span>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <input type="text" name="tags" id="tags" required
                           class="w-full px-4 py-3 bg-gray-800 bg-opacity-50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 transition-all duration-300"
                           placeholder="e.g., Leadership, Education, Management" value="{{ old('tags') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="hidden" name="gradient_from" id="gradient_from" value="{{ old('gradient_from', '#3B82F6') }}">
                    
                    <!-- Color Preview -->
                    <div class="mb-3 p-3 bg-gray-800 bg-opacity-50 border border-gray-600 rounded-lg">
                        <div class="flex items-center space-x-3">
                            <div id="gradient-from-preview" class="w-8 h-8 rounded-lg border-2 border-gray-500" style="background: #3B82F6;"></div>
                            <span id="gradient-from-text" class="text-white text-sm">#3B82F6</span>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <input type="hidden" name="gradient_to" id="gradient_to" value="{{ old('gradient_to', '#7C3AED') }}">
                    
                    <!-- Color Preview -->
                    <div class="mb-3 p-3 bg-gray-800 bg-opacity-50 border border-gray-600 rounded-lg">
                        <div class="flex items-center space-x-3">
                            <div id="gradient-to-preview" class="w-8 h-8 rounded-lg border-2 border-gray-500" style="background: #7C3AED;"></div>
                            <span id="gradient-to-text" class="text-white text-sm">#7C3AED</span>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="duration" id="duration"
                               class="w-full px-4 py-3 bg-gray-800 bg-opacity-50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 transition-all duration-300"
                               placeholder="e.g., 2023 - Present" value="{{ old('duration') }}" readonly>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="location" id="location"
                               class="w-full px-4 py-3 bg-gray-800 bg-opacity-50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 transition-all duration-300"
                               placeholder="e.g., Indonesia" value="{{ old('location') }}" readonly>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    locationPickerBtn.addEventListener('click', function() {
        console.log('Location picker clicked in create page!');
